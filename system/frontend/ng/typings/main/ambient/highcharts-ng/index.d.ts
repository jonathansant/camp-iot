...
declare module "highcharts-ng" {
    interface HighChartsNGConfig {
        options: any;// HighchartsOptions;
        //The below properties are watched separately for changes.

        //Series object (optional) - a list of series using normal highcharts series options.
        series?: any[];//HighchartsIndividualSeriesOptions[];
        ...
        func?: (chart: any/*HighchartsChartObject*/) => void;
    }
...
//Instantiated Chart
    interface HighChartsNGChart extends HighChartsNGConfig {
        ...
        getHighcharts(): any;//HighchartsChartObject;
    }
}